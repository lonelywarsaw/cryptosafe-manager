# Мастер первого запуска — задать пароль, выбрать куда сохранять БД, кнопки шифрования.
...
from PyQt6.QtWidgets import (
    ...
    QFileDialog, QGroupBox, QWidget, QFormLayout, QMessageBox,
)
...
class SetupWizard(QDialog):
    ...
    def _finish(self):
        ...
        if pwd != self._confirm.text().strip():
            ...
            return
        import hashlib
        config.set(config.MASTER_PASSWORD_HASH, hashlib.sha256(pwd.encode("utf-8")).hexdigest())
        self.accept()
